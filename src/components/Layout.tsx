        ...
        <style type="text/css">
          {`
            ...
            #pageContent {
              ...
              padding-top: 20px;
              line-height: 1.65em;
              background-image: url(/assets/backblue.gif);
            ...
            .tblRegular td {
              padding: 6px;
              background-image: url(/assets/fade.gif);
      ...
      <body>
        ...
        >
          <tr>
            <td id="footer">
              <small>
                &copy; 2008 Xavier Roche & other contributors - Web Design:
                Leto Kauler.
              </small>
            </td>
          </tr>
